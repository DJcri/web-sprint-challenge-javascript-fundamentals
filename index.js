...
// its' a closure and can access the variables inside the scope of it's parent function
...
function USApop(/*Your Code Here*/) {
  /*Your Code Here*/
  return zooAnimals.reduce((acc, animal) => {
    return { population: (acc.population += animal.population) };
  }).population;
}
...
const cuboid = new CuboidMaker({ width: 4, length: 5, height: 5 });
...
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
const cuboidTwo = new CuboidMakerTwo({ width: 4, length: 5, height: 5 });
...
const cube = new CubeMaker({ width: 2, length: 2, height: 2 });
